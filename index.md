...
> 检索时间范围：**2026-07-26 至 2026-08-25**
> 数据检索到 **27** 篇相关论文，按提交时间降序排列

---

## 1. Interaction-mediated Co-existence of Altermagnetism and Topology
...
## 2. Berry-Curvature Effect in Anomalous Transport
...
## 3. Anti-spin Laue groups: classification of anti-altermagnets and their representative minimal models
...
## 4. Topological Altermagnetic Insulators
...
## 5. Design of altermagnetism in oxide superlattices exploiting interface effects and quantum confinement
...
## 6. Antiferroquadrupolar Order in Altermagnetic CoF${}\_2$
...
## 7. Rapid supercurrent decay in Mn${}\_5$Si${}\_3$ Josephson junctions
...
## 8. Two routes to quantum anomalous Hall states in altermagnets
...
## 9. Spin-polarized supercurrents and Josephson diode effect in altermagnets
...
## 10. Spin Splitter without Spin-Split Bands: A Reconfigurable Altermagnetic Texture
...
## 11. Quantum Mechanism of Piezomagnetism in Higher-Spin Altermagnets
...
## 12. A spin-bond theory unifying non-relativistic spin splitting and emergent spin-orbit textures
...
## 13. Magnetotransport evolution and nonlinear Hall effect in altermagnetic MnTe
...
## 14. Microscopic Origin of Spin Splitting in Altermagnetic CrSb Thin Films
...
## 15. Correlated topological-polarization surface states in the narrow-gap insulator FeSb2
...
## 16. Antisymmetric Dynamical Spin Correlations: Spin-Space-Group Constraints and Frequency-Moment Sum Rules
...
## 17. Emergence and Detection of Surface altermagnetism in KV${}\_2$Se${}\_2$O
...
## 18. Magnetic circular dichroism of THz modes and selection rules of Raman-active optical phonons in the polar altermagnet candidate \ce\{Mn2Mo3O8\}
...
## 19. Study of the Anomalous Hall effect by tuning the spin orientation in the Altermagnetic material CrSb
...
## 20. Coupled Spin-Density-Wave and Bond-Order Driven Metal-Insulator Transition in Altermagnetic CsCr${}\_2$S${}\_2$O
...
## 21. Thermal spin transport in easy-planar $d$-wave altermagnets controlled by magnetic field
...
## 22. Many-Body Amplification of Ligand Instabilities Driving Verwey-Type Transitions in Altermagnet CsCr${}\_2$S${}\_2$O
...
## 23. Altermagnetism from a Cu-Fe Lieb Lattice in FeSe/Cuprate Heterostructures
...
## 24. Ferroelectric switchable altermagnetic-like compensated ferrimagnets with charge ordering
...
## 25. Stacking-dependent anisotropic altermagnetism in V${}\_{1/3}$NbS${}\_2$
...
## 26. Chiral Magnons: Mechanisms and Research Progress
...
## 27. Pair-Density Wave from Doping an Altermagnetic Mott Insulator
